...
public final class MyBenchmark {
    ...
    public Collection<? extends Result> testMethod_Throughput(InfraControl control, ThreadControl threadControl) throws Throwable {

        if (threadControl.subgroup == 0) {
            MyBenchmark_1_jmh l_bench = tryInit_f_bench(control, new MyBenchmark_1_jmh());
            ...
            testMethod_Throughput_measurementLoop(control, res, l_bench, l_blackhole);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "testMethod", res.getOperations(), res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");

    }
    public  void testMethod_Throughput_measurementLoop(InfraControl control, RawResults result, MyBenchmark_1_jmh l_bench, BlackHole_1_jmh l_blackhole) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> testMethod_AverageTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            MyBenchmark_1_jmh l_bench = tryInit_f_bench(control, new MyBenchmark_1_jmh());
            BlackHole_1_jmh l_blackhole = tryInit_f_blackhole(control, new BlackHole_1_jmh());
            ...
            RawResults res = new RawResults(1L);
            testMethod_AverageTime_measurementLoop(control, res, l_bench, l_blackhole);
            control.announceWarmdownReady();
            while (control.warmdownShouldWait) {
                l_bench.testMethod();
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "testMethod", res.getOperations(), res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");

    }
    public  void testMethod_AverageTime_measurementLoop(InfraControl control, RawResults result, MyBenchmark_1_jmh l_bench, BlackHole_1_jmh l_blackhole) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> testMethod_SampleTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        ...
        if (threadControl.subgroup == 0) {
            ...
            testMethod_SampleTime_measurementLoop(control, buffer, l_bench, l_blackhole);
            control.announceWarmdownReady();
            while (control.warmdownShouldWait) {
                l_bench.testMethod();
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "testMethod", buffer, tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    public  void testMethod_SampleTime_measurementLoop(InfraControl control, SampleBuffer buffer, MyBenchmark_1_jmh l_bench, BlackHole_1_jmh l_blackhole) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> testMethod_SingleShotTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        long realTime = 0;
        if (threadControl.subgroup == 0) {
            MyBenchmark_1_jmh l_bench = tryInit_f_bench(control, new MyBenchmark_1_jmh());
            BlackHole_1_jmh l_blackhole = tryInit_f_blackhole(control, new BlackHole_1_jmh());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MILLISECONDS;
            results.add(new SingleShotResult(ResultRole.PRIMARY, "testMethod", (realTime > 0) ? realTime : (time2 - time1), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    MyBenchmark_1_jmh f_bench;
    
    MyBenchmark_1_jmh tryInit_f_bench(InfraControl control, MyBenchmark_1_jmh val) throws Throwable {
        if (f_bench == null) {
                    val.readyTrial = true;
              f_bench = val;
        }
    ...
    static class MyBenchmark_1_jmh_B1 extends xyz.MyBenchmark {
